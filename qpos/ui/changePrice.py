...
"background-color: rgb(159, 217, 111);")
        ...
        self.productNameLabel.setStyleSheet("font: 75 20pt \"Sego UI\"")
        ...
        self.productNameBox.setStyleSheet("font: 75 20pt \"Sego UI\"")
        ...
        self.originalPriceLabel.setStyleSheet("font: 75 20pt \"Sego UI\";")
        self.originalPriceLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.originalPriceBox.setStyleSheet("font: 75 20pt \"Sego UI\";\n")
        ...
        self.newPriceLabel.setStyleSheet("font: 75 20pt \"Sego UI\";")
        self.newPriceLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.newPriceBox.setStyleSheet("font: 75 20pt \"Sego UI\";\n")
...
"background-color: rgb(255, 94, 97);")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Change Price"))
        ...
        self.originalPriceLabel.setText(_translate("Form", "기존 Amount"))
        self.newPriceLabel.setText(_translate("Form", "변경 Amount"))
...
class ChangePrice(QMainWindow, Ui_Form):
    ...
    def checkValidation(self, productName, productPrice, newPrice):
        ...
        if productPrice < 0 or newPrice < 0:
            warning = QMessageBox()
            warning.setIcon(QMessageBox.Warning)
            warning.setText("0이상의 Amount을 입력하십시오")
            warning.setWindowTitle("오류")
            warning.exec()
            return False
